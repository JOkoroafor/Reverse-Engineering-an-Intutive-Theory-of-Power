...
plt.xlabel("Model Predictions1", fontsize = 20)
...
print(f"Correlation between Model and Human P(In) for Player 1: {correlation_p_in:.2f}")
print(f"Adjusted R^2 for P(In) for Player 1: {adj_r2_p_in:.2f}")
print(f"Correlation between Model and Human P(Right) for Player 2: {correlation_p_right:.2f}")
print(f"Adjusted R^2 for P(Right) for Player 2: {adj_r2_p_right:.2f}")
