...
# Model predictions
# Average_Relative_Resource_Control = {
 #    "common_interest": 1,
 #    "safe_shot": 2.77,
 #    "strategic_dummy": 1,
 #    "near_dictator": 0.236,
...
for game in Average_Relative_Resource_Control.keys():
    model.append(Average_Relative_Resource_Control[game])
...
for game, data in Average_Relative_Resource_Control.items():
    plt.errorbar(
...
print(f"Correlation between Relative_Resource_Control and Power: {correlation:.2f}")
