...
beta_params = [
    (1.25, 1.75, 0, 1),  # Slightly skewed
    (5, 2, 0, 1),        # Right-skewed
    (3, 3, 0, 1),         # Symmetric Beta
    (-3, 1.75, 0, 1),    # Flipped
...
ax.plot([0, 1], [1, 0], color='green', linestyle='--')  # Diagonal line
ax.plot([1, 0], [0, -1], color='purple', linestyle='--')  # Diagonal line
ax.plot([0, -1], [-1, 0], color='red', linestyle='--')  # Diagonal line
ax.plot([-1, 0], [0, 1], color='blue', linestyle='--')  # Diagonal line
...
output_filename = "beta_distribution_plot.png"
